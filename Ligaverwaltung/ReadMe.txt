========================================================================
    KONSOLENANWENDUNG: Ligaverwaltung-Projektübersicht
========================================================================

Diese Ligaverwaltung-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Ligaverwaltung-Anwendung besteht.


Ligaverwaltung.vcxproj
...
Ligaverwaltung.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Ligaverwaltung.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
